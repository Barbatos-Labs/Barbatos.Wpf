...
/// </summary>
/// <remarks>
/// This is the WPF counterpart of .NET MAUI's <c>Permissions</c>. See the remarks on
/// <see cref="BasePlatformPermission"/> (in <c>PermissionsImplementation.cs</c>) for how each
/// permission behaves on this platform.
/// </remarks>
public static partial class Permissions
{
    ...
    /// </summary>
    /// <remarks>Only used on Android in .NET MAUI; always returns <see langword="false"/> on WPF.</remarks>
    /// <typeparam name="TPermission">The permission type to check.</typeparam>
