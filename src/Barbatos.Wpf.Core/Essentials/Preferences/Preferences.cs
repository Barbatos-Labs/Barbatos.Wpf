...
/// </summary>
/// <remarks>This is the WPF counterpart of .NET MAUI's <c>IPreferences</c>; data is stored in
/// a local JSON file under <see cref="FileSystem.AppDataDirectory"/>.</remarks>
...
/// The Preferences API helps to store application preferences in a key/value store.
/// </summary>
/// <remarks>This is the WPF counterpart of .NET MAUI's <c>Preferences</c>.</remarks>
public static class Preferences
{
    ...
    static IPreferences Current => Default;

    internal static string GetPrivatePreferencesSharedName(string feature) =>
        $"{AppInfo.Current.AppGuid}.barbatos.wpf.essentials.{feature}";
